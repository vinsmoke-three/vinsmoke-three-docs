...
- **[Question Answering](docs/LLM/ClassicalNLP/75_question_answering.md)** - 抽出型質問応答システムの実装

### Tools

#### Claude Code

- **[Commands](docs/Tools/ClaudeCode/claude_code_commands.md)** - Claude Code CLIで利用可能な全組み込みスラッシュコマンドの一覧と説明
- **[Hooks](docs/Tools/ClaudeCode/claude_code_hooks.md)** - ツール実行のライフサイクルにシェルスクリプトを組み込み、確実な動作を保証する方法

#### Superpowers

- **[Superpowers 概要](docs/Tools/Superpowers/superpowers_overview.md)** - Skillが「行動制御コード」として機能する仕組みと設計思想
- **[SessionStart Hook](docs/Tools/Superpowers/superpowers_session_start.md)** - セッション開始時にusing-superpowersスキルを強制注入する仕組み
- **[Skill設計哲学](docs/Tools/Superpowers/superpowers_skill_design.md)** - LLMを従わせるSkillの設計パターンと説得心理学の応用
- **[Subagentアーキテクチャ](docs/Tools/Superpowers/superpowers_subagent.md)** - AgentがAgentを管理するsubagent-driven-developmentの解説
- **[SkillのTDD](docs/Tools/Superpowers/superpowers_skill_tdd.md)** - スキル自体をTDDで開発する手法と圧力テスト
